...
It’s built on Base UI, which is in alpha, so there may be changes in the future. However, we’re actively testing and refining it. If you’re comfortable with an early-stage library and ready to adapt as it matures, you can use it in production. Just ensure you perform your own checks and stay updated with any changes.
